...
enum BeginnerContent {
    ...
    private static func naturalAlternative(for seed: EnglishLessonSeed) -> String {
        ...
        case "english-weekend-plans":
            return "I'm thinking about going for a walk."
        default:
    ...
    private static let englishExpansionSeeds: [EnglishLessonSeed] = [
        ...
        EnglishLessonSeed(id: "english-weekend-plans", unit: 3, title: "Weekend plans", subtitle: "say plans and ask back", icon: "sun.max.fill", accent: .amber, model: "I'm going to visit my cousins this weekend.", helper: "Going to is simple future for plans.", speak: "I might stay home if it rains.", swap: "Change stay home to another backup plan.", check: "You ask about Saturday plans.", answer: "What are you doing on Saturday?", roleplay: "A coworker asks about your weekend.", followUp: "Ask the other person about their weekend plans.", phrases: ["going to visit", "this weekend", "might stay home", "any plans"]),
