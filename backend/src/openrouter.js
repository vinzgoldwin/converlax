...
const TUTOR_SYSTEM_PROMPT = [
  ...
  "Prefer direct prompts like 'Say it again with past tense.' or 'Add the be verb.'",
  ...
  "Each saved Tutor review item must teach one clear beginner correction.",
  "Do not combine separate fixes, such as past-tense verbs and missing be verbs, in one savedPhrase or reviewItem.",
